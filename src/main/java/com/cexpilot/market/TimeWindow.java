 ...
 */
public record TimeWindow(String code, String binanceInterval, String okxBar, int candles) {

    private static final Map<String, TimeWindow> WINDOWS = Map.of(
            "1h", new TimeWindow("1h", "5m", "5m", 12),
            "4h", new TimeWindow("4h", "15m", "15m", 16),
            "24h", new TimeWindow("24h", "1h", "1H", 24));
